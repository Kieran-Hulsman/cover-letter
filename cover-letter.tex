...
\hline
\vspace{5pt}
\textbf{Languages: } C/C++, Python, Java, JavaScript, HTML/CSS, VHDL

\vspace{1pt}
\textbf{Technologies: } Git, Unix/Linux, AWS, Excel, GTest, MISRA-C, LaTeX, OpenPyXL
\vspace{3pt}
\hline
...
\section{Experience}
    ...
    \resumeItemListStart
        ...
        \resumeItem{Combed through \textbf{Excel} sheets to update \textbf{2000+} clients in Function Point and QuickBooks Online}
    \resumeItemListEnd
    ...
    \resumeItemListStart
        ...
        \resumeItem{Responsible for the setup and maintenance of our \textbf{30 devices}, ensuring the smooth IT operations of the business}
        \resumeItem{Established and implemented the franchise's adminsitrative systems as the business' first full-time employee}
        \resumeItem{Led \textbf{100+} educational coding sessions for children aged 5-14, fostering digital literacy and problem-solving skills}
    \resumeItemListEnd
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
            ...
            {\raisebox{-0.1\height}\faExternalLink\ \textbf{ForAllTimes - Lounge Traffic Monitor}} $|$ \normalEMPH{Python, JavaScript, HTML/CSS, Git}}
            {Oct. 2022 -- Jan. 2023}
            \resumeItemListStart
                \resumeItem{Developed a traffic counter, enhancing student's ability to find quiet study spots with an accuracy rate of \textbf{90\%}}
                ...
                \resumeItem{Registered our Raspberry Pi as an \textbf{AWS IoT} device to send entry/exit data from our \textbf{ultrasonic sensors} to the cloud}
                \resumeItem{Implemented an \textbf{AWS Lambda} function in \textbf{Python} to process data from the \textbf{Raspberry Pi} and update our database}
                \resumeItem{Utilized \textbf{DynamoDB} to track the number of students in the lounge, displaying the data on our website's front-end}
            \resumeItemListEnd
            ...
            $|$ \normalEMPH{JavaScript, HTML/CSS, Git}}{Sep. 2022}
            \resumeItemListStart
